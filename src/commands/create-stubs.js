...
async function createDependencyFlowTypeStubs({useRoot = false}: Object = {}) {
  ...
  for (const cwd of packagePaths) {
    ...
    for (const key of allowedStubDependencyKeys) {
      await flowTyped.createStubsForInDirectDependencies(targetCwd, key);
    }
  }
}

module.exports = createDependencyFlowTypeStubs;
